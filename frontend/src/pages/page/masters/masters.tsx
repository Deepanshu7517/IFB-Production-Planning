...
const API_URL = `${API_BASE}/masters`;
...
const Masters: React.FC = () => {
  ...
  const filteredBoms = boms
    .filter(
      (b) =>
        ...
        b.partNumber === currentSelectedBom,
    )
    .filter((b) =>
  ...
  const renderTableRow = (item: MasterItem) => {
    ...
    switch (activeTab) {
      case "Plant":
        return (
          <>
            ...
            <td className="font-semibold max-w-xs truncate">{item.plantName}</td>
      ...
      case "AssemblyLine":
        return (
          <>
            ...
            <td className="max-w-xs truncate">{item.assemblyLineName}</td>
            <td className="tabular-nums font-semibold">{item.capacity}</td>
            <td>
      ...
      case "Model":
        return (
          <>
            ...
            <td className="max-w-xs truncate font-semibold">{item.modelName}</td>
            <td>
              <span className="badge badge-ghost badge-sm flex-nowrap">
      ...
      case "BOM": {
        ...
        return (
          <>
            ...
            <td className="max-w-xs truncate">{item.partName}</td>

            {/* Model — manually set */}
            <td>
              {hasModel ? (
                <span className="badge badge-primary badge-sm flex-nowrap">
        ...
        return (
          <>
            ...
            <td>
              ...
              <div className="text-xs opacity-60 max-w-xs truncate">{plant.plantName}</div>
            </td>
            ...
            <td>
              ...
              <div className="text-xs opacity-60 max-w-xs truncate">{al.assemblyLineName}</div>
            </td>
            ...
            <td>
              ...
              <div className="text-xs opacity-60 max-w-xs truncate">{model.modelName}</div>
            </td>
            ...
            {/* Part Name */}
            <td className="text-sm max-w-xs truncate font-medium">{bom.partName || "—"}</td>

            {/* Child Parts */}
            <td>
              <span className="badge badge-outline badge-sm flex-nowrap">
                {childCount} part{childCount !== 1 ? "s" : ""}
              </span>
            </td>
              ...
              <div className="flex items-center gap-4 flex-nowrap">
                {(["A", "B", "C"] as const).map((s) => {
                  ...
                  return (
                    <label
                      key={s}
                      className="flex items-center gap-2 cursor-pointer flex-nowrap"
                    >
                      <input
                        type="checkbox"
      ...
      case "Users":
        return (
          <>
            <td className="font-semibold max-w-xs truncate">{item.name}</td>
            <td className="max-w-xs truncate font-mono text-sm">{item.username}</td>
            <td className="max-w-xs truncate">{item.email}</td>
            <td className="font-mono text-xs font-semibold">
              {item.employeeId}
            </td>
            <td>
          ...
          {isEditing && (
            <div className="mt-3 space-y-1">
              <p className="text-xs opacity-60">
                Plant ID: <span className="font-mono font-semibold">{formData.plantId}</span> (auto-generated)
              </p>
              <p className="text-xs opacity-60">
                Created: {formData.createdAt ? new Date(formData.createdAt).toLocaleDateString("en-IN") : "—"}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          {isEditing && (
            <p className="text-xs opacity-60 mt-2">
              Assembly Line ID: <span className="font-mono font-semibold">{formData.assemblyLineId}</span> (auto-generated)
            </p>
          )}
        </div>
      );
    ...
    if (activeTab === "Model") {
      return (
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="form-control">
            ...
            <SearchSelect
              options={assemblyLines.map((al) => ({
                value: al._id,
                label: `${al.assemblyLineId} — ${al.assemblyLineName}${
          ...
          {isEditing && (
            <p className="text-xs opacity-60 mt-2">
              Model ID: <span className="font-mono font-semibold">{formData.modelId}</span> (auto-generated)
            </p>
          )}
        </div>
      );
              ...
              {model.modelId ? (
                <>
                  ...
                  <div className="flex items-center gap-3 pl-4 border-l-2 border-base-300">
                    ...
                    {al.capacity != null && (
                      <span className="ml-auto opacity-50 tabular-nums shrink-0">
                  ...
                  <div className="flex items-center gap-3 pl-8 border-l-2 border-base-300">
                    ...
                    <span className="font-semibold truncate max-w-xs">{model.modelName}</span>
                  </div>
  ...
  return (
    <div className="p-6">
      ...
      {/* Table */}
      <div className="overflow-x-auto bg-base-100 rounded-lg shadow border border-base-200 h-[70vh]">
      ...
      {metaItem && (
        <div className="modal modal-open">
          <div className="modal-box w-11/12 max-w-md">
            ...
            <p className="text-xs opacity-40 mb-4 truncate">{metaItem.partName}</p>
...
//         )}
//       {/* Table */}
//       <div className="overflow-x-auto bg-base-100 rounded-lg shadow border border-base-200 h-[60vh]">
//         <table className="table w-full">
//           <thead className="bg-base-200 sticky top-0 z-10">
//             <tr>{renderTableHeaders()}</tr>
//           </thead>
